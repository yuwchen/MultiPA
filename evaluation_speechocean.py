...
def calculate_performance(result_word, result_uttr, wav_idx_word, wav_idx_uttr):
    ...
    print('number of sentences for word', count_sen, len(pred_w_acc))
    print('word acc')
...
resultA_word, resultA_uttr = get_prediction('./Results/model_assessment_val9_r5_speechocean762_test_gtb.txt')
